...
### 功能增强
- **Redis集成**：添加了Redis缓存功能以优化系统性能，包括Redis连接测试组件
- **角色升级**：将管理员角色升级为超级管理员角色，优化了用户权限体系
- **数据库优化**：升级了MySQL版本并优化了用户注册功能
...
- **管理员重构**：重构了管理员实体和数据访问层
- **前端重构**：重构了前端界面和路由结构，优化了用户体验

### 性能与安全
- **身份验证**：添加了token验证功能，增强了系统安全性
- **路由保护**：添加路由守卫防止已登录用户访问登录页面
- **注册限制**：禁用了注册功能，确保系统安全性

### 用户体验
- **界面优化**：隐藏了脚手架管理系统标题，优化了界面显示
- **主题调整**：移除了主题切换功能并更新了标题
- **登录优化**：移除了扫码登录功能并简化了登录界面，移除了账号长度验证规则
